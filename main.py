...
# 監控清單 (已加入 威盛 2388.TW 與 聯陽 3014.TW)
STOCKS_TO_TRACK = {
    # 1. 矽晶圓與晶圓代工
    ...
    # 3. 高速傳輸、BMC、記憶體與控制器 (已加入威盛 2388.TW)
    ...
    # 7. 矽光子 (CPO)、光通訊與高階網通 (已加入聯陽 3014.TW)
    ...
    "3047.TW": "訊舟", "6451.TWO": "統新", "3014.TW": "聯陽",
...
def generate_stock_report():
    ...
    print(f"⏳ 正在批次下載 {len(tickers)} 日/檔技術面資料...")
    data = pd.DataFrame()
